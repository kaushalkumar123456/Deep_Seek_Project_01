...
st.title("Compare Response Using Both Model Using Uploaded Pdf")
...
if st.button("Answer"):
    ...
    with col1:
        ...
        st.markdown(
            f"""
            <div style="border: 1px solid #ccc; padding: 10px; border-radius: 5px; background-color:#e6b3ff;">
                {answer_deepseek}
            </div>
            """,
    ...
    with col2:
        ...
        st.markdown(
            f"""
            <div style="border: 1px solid #ccc; padding: 10px; border-radius: 5px; background-color: #ccddff;">
                {answer_llama3}
            </div>
            """,
            unsafe_allow_html=True
